...
public class TcpServer extends Thread implements UserManager.UserManagerDelegate {
    ...
    public void userConnected(User connectedUser) {
        ...
        System.out.println("User " + connectedUser.getUsername() + " is now connected.");
    ...
    public void messageReceived(User fromUser, User toUser) {
        ...
        System.out.println("User " + fromUser.getUsername() + " says: " + fromUser.getMessage() + " to user: " + (toUser == null ? "ALL" : toUser.getUsername()));
