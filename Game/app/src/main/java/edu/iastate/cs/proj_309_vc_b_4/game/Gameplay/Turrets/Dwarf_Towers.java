 ...
 *
 * Provides static methods as templates for other classes to create human dwarven turrets
 *
 */

public class Dwarf_Towers {

    /**
     *
     * @param gameLogic
     * @param position position of the turret on screen
     * @return a dwarf turret that can target flying and ground units
     */
    public static Turret dwarf_anti_air(GameLogic gameLogic, Position position){
     ...
     * @param gameLogic
     * @param position position of the turret on screen
     * @return a dwarf turret that can target burrowing and ground units
     */
    public static Turret dwarf_anti_burrowing(GameLogic gameLogic, Position position){
     ...
     * @param gameLogic
     * @param position position of the turret on screen
     * @return a dwarf turret that can only target ground units
     */
    public static Turret dwarf_basic_turret(GameLogic gameLogic, Position position){
     ...
     * @param gameLogic
     * @param position position of the turret on screen
     * @return a dwarf turret that can target any and all
     */
    public static Turret dwarf_all_turret(GameLogic gameLogic, Position position){
